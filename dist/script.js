...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="up"]'); // checkNumInputs('input[name="user_phone"]');
...
var mask = function mask(selector) {
  var setCursorPosition = function setCursorPosition(pos, elem) {
    ...
    if (elem.setSelectiobRange) {
      elem.setSelectiobRange(pos, pos);
...
var pictureSize = function pictureSize(imgSelector) {
  ...
  function showImg(block) {
    var img = block.querySelector('img'); // image.png => image-1.png
  ...
  function hideImg(block) {
    var img = block.querySelector('img'); // image-1.png => image.png
...
var scrolling = function scrolling(upSelector) {
  ...
  }); // scrolling on RequestAnimationFrame
